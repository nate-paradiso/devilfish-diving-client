      ...
      <section className="flex justify-center items-center flex-col ml-4 mr-4">
        <div className="flex w-full ">
          <div
            ...
            }  bg-cover bg-center w-full flex justify-center items-center h-[250px] md:h-[500px] lg:h-[600px] bg-white shadow-md rounded-md p-3 mr-1`}
          ...
          >
            <Link href="/Photos">
              <h2 className="text-white md:text-6xl text-2xl font-oleoScript tracking-wider transition-colors duration-200 hover:text-slate-300  ">
                Diving
              </h2>
            </Link>
          </div>
          <div
            ...
            } bg-cover bg-center w-full flex justify-center items-center h-[250px] md:h-[500px] lg:h-[600px] bg-white shadow-md rounded-md p-3 ml-1`}
          ...
          >
            <Link href="/Photos">
              <h2 className="text-white md:text-6xl text-center text-2xl font-oleoScript tracking-wider transition-colors duration-200 hover:text-slate-300   ">
                Sight Seeing
              </h2>
            </Link>
          </div>
        ...
        <div>
          <h1 className="bg-white shadow-md rounded-md p-3  border-[1px] m-8 text-2xl">
            Discover the Puget Sound!
          </h1>
        </div>
        <div
          className="bg-cover bg-center w-full flex justify-center items-center bg-white shadow-md rounded-md p-3 mr-4 ml-4 mb-4 "
          style={{
        ...
        >
          {/* <Link href="/Calendar"> */}
          <div className="">
            <h2 className=" m-10 lg:m-16 text-xl text-center text-#0E1111 border-[1px]  bg-white shadow-md rounded-md p-2">
              Launching from Alki
            </h2>
          </div>
          {/* </Link> */}
