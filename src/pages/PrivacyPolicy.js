    ...
    <div className="flex justify-center">
      <div className="max-w-[800px] p-4 flex flex-col bg-white bg-opacity-60 shadow-md rounded-md m-4">
        ...
        <p>
          ...
          without your consent, except as required by law or as necessary to provide services to
          you.
        </p>
        <br />
        ...
        <p>
          ...
          outlined in this Privacy Policy. The criteria used to determine the retention periods
          include the nature of the data, the purposes for which it is processed, and any legal or
