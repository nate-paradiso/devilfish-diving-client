  ...
  return (
    <div className="max-w-[800px] p-4 flex flex-col m-auto bg-white bg-opacity-60 shadow-md rounded-md mb-4">
      ...
      <ul className="list-disc list-inside pl-4">
        ...
        <li>
          Cancellations made within 2 days (48 hours) of the scheduled service will not be eligible
          for a refund.
        </li>
        <li>
          In the event of unforeseen circumstances by the charter or weather-related, a 100% refund
          will be granted.
        </li>
      </ul>
      <br />
