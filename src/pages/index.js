      ...
      <section className="flex justify-center items-center flex-col ml-4 mr-4">
        <div className="flex w-full ">
          <div
            ...
            }  bg-cover bg-center w-full flex justify-center items-center h-[250px] md:h-[500px] lg:h-[600px] bg-white bg-opacity-60 shadow-md rounded-md p-3 mr-1`}
          ...
          <div
            ...
            } bg-cover bg-center w-full flex justify-center items-center h-[250px] md:h-[500px] lg:h-[600px] bg-white bg-opacity-60 shadow-md rounded-md p-3 ml-1`}
